...
# ── Default metric weights (from legacy scores.py) ────────────────────────────
DEFAULT_WEIGHTS = {
...
# ── Default thresholds (from legacy bayesian_optimizer.py) ─────────────────────
DEFAULT_MIN_CLUSTERS = 35
DEFAULT_MAX_DOMINANCE = 0.08
DEFAULT_MAX_OUTLIER_RATIO = 0.15
DEFAULT_KEYWORD_DIVERSITY_THRESHOLD = 0.6
